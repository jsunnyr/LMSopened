===========================
GNU/Linux     [GNU_Linux]_
===========================
.. image:: ../images/gnu-linux.jpeg
...
后记
除了GNU，还有一个独立进行的工程开发了一个自由的类似Unix的操作系统。这个系统是BSD，它是由UC Berkeley开发的。在80年代，BSD还不是自由的，但是它在90年代变成了自由软件。今天，一个自由的操作系统(4)差不多如果不是GNU系统的派生版本，就是BSD系统的派生版本。
